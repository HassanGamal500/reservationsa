...
@section('page_title')
    {{trans('admin.detail reservation hospital')}}
@endsection
@section('content')
<!-- Begin Page Content -->
            ...
            <div class="col-12">
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row invoice-info">
                        ...
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
                            <b>{{trans('admin.hospital')}}:</b> {{$reservation[0]->hospital_name}}<br>
                                ...
                                @csrf
                                    <div class="form-group">
                                        <select class="custom-select" name="status_name" required>
                                            <option value="" disabled selected>{{trans('admin.select status')}}</option>
