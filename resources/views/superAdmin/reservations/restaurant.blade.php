...
@section('page_title')
    {{trans('admin.reservation restaurant')}}
@endsection
@section('content')
<!-- Begin Page Content -->
<div class="container-fluid">
    ...
    <h1 class="h3 mb-2 text-gray-800">{{trans('admin.reservations')}} - {{$restaurant->restaurant_name}}</h1>
    @else
            ...
            <div class="table-responsive">
                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-primary" href="{{url(route('restaurant_show', $reservation->id))}}">{{trans('admin.show')}}</a></td>
                    </tr>
                    @endforeach
                    </tbody>
                </table>
