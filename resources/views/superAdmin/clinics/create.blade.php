    ...
    <div class="container-fluid">
        ...
        <form method="post" action="{{route('store_clinic')}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="tel" pattern="^[0-9]*$" name="clinic_phone" class="form-control" maxlength="13" placeholder="{{trans('admin.enter phone')}}" value="{{ old('clinic_phone') }}" required>
            </div>
            <div class="form-group">
                <label>{{trans('admin.upload photo')}}</label>
                <input type="file" name="clinic_image" class="form-control-file" required>
            </div>
            <div class="form-group">
                <label>{{trans('admin.description part')}} ({{trans('admin.english')}})</label>
                <input type="text" pattern="^[A-Za-z0-9_.,/{}@#!~%()-<>\s]+$" name="clinic_description_part[1]" class="form-control" maxlength="140" placeholder="{{trans('admin.enter description part')}}" value="{{ old('clinic_description_part.1') }}" required>
            </div>
            <div class="form-group">
                <label>{{trans('admin.description part')}} ({{trans('admin.arabic')}})</label>
                <input type="text" pattern="^[\u0621-\u064A\u0660-\u0669\u06f0-\u06f9\u0600-\u06FF\sA-Za-z0-9_.,/{}@#!~%()<>-]+$" name="clinic_description_part[2]" class="form-control" maxlength="140" placeholder="{{trans('admin.enter description part')}}" value="{{ old('clinic_description_part.2') }}" required>
            </div>
            <div class="form-group">
                <label>{{trans('admin.description full')}} ({{trans('admin.english')}})</label>
                <textarea type="text" pattern="^[A-Za-z0-9_.,/{}@#!~%()-<>\s]+$" name="clinic_description_full[1]" class="form-control" placeholder="{{trans('admin.enter description full')}}" required>{{ old('clinic_description_full.1') }}</textarea>
            </div>
            <div class="form-group">
                <label>{{trans('admin.description full')}} ({{trans('admin.arabic')}})</label>
                <textarea type="text" pattern="^[\u0621-\u064A\u0660-\u0669\u06f0-\u06f9\u0600-\u06FF\sA-Za-z0-9_.,/{}@#!~%()<>-]+$" name="clinic_description_full[2]" class="form-control" placeholder="{{trans('admin.enter description full')}}" required>{{ old('clinic_description_full.2') }}</textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" pattern="^[0-9.,\u0660-\u0669\u06f0-\u06f9]+$" name="clinic_latitude" class="form-control" placeholder="{{trans('admin.enter latitude')}}" value="{{ old('clinic_latitude') }}" required>
            </div>
            <div class="form-group">
                <label>{{trans('admin.longitude')}}</label>
                <input type="text" pattern="^[0-9.,\u0660-\u0669\u06f0-\u06f9]+$" name="clinic_longitude" class="form-control" placeholder="{{trans('admin.enter longitude')}}" value="{{ old('clinic_longitude') }}" required>
            </div>
            <hr>
            <div class="form-group">
