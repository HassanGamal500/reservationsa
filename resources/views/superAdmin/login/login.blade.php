                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="{{ route('admin.login.post') }}">
                                    ...
                                    <div class="form-group">
                                        <input type="email" name="email" class="form-control form-control-user" value="{{ old('email') }}" aria-describedby="emailHelp" placeholder="{{trans('admin.enter email')}}....">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" name="password" class="form-control form-control-user" placeholder="{{trans('admin.enter password')}}">
                                    </div>
                                    <div class="form-group">
